 ...
 *
  2014-07-01 Lancer--Sets inverted channel flag on startup
  2014-08-04 Lancer--Modifications to prevent different channels stepping on each other
  2015-10-05 Lancer--Modifications to improve performance with rapid RGB writes in succession.
...
static DEFINE_SEMAPHORE(led_state);
...
static void pca9633_led_work(struct work_struct *work)
{
	...
	ledout = i2c_smbus_read_byte_data(pca9633->client, PCA9633_LEDOUT);
					...
					const struct i2c_device_id *id)
{
	...
	/* set inverted output for fets */
	i2c_smbus_write_byte_data(client, PCA9633_MODE2, 0x15);
